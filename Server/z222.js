...
app.get('/post_like/:id', async(req, res) => {
...
app.get('/post_unlike/:id', async(req, res) => {
...
const qw22zcnt2 = await db('movies').select('name','id','views','vlike', 'video_typpe').limit(5).orderBy('id','desc');
